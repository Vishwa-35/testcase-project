...
from testmanager.services import get_active_instance, get_current_active_version
from testmanager.utils import clean, clean_slno, get_requirement_id
from testmanager.constants import (
    ACTIVITY_ACTION_ADD,
    ACTIVITY_ACTION_EDIT,
)
from testmanager.decorators import (
...
from testmanager.logging_utils import log_debug, log_error
...
def testcase_list(request):
    ...
    if selected_version and selected_sw and is_manager_check:
        ...
        if is_manager_check:
            ...
            from testmanager.version_service import filter_queryset_by_latest_versions
    ...
    if not is_manager_check:
        ...
        from testmanager.version_service import get_versions_for_user
        from ..models import TestCaseSheet
    ...
    if not is_manager_check and active_version:
        ...
        from testmanager.version_service import get_versions_for_user, can_user_access_version
...
def create_new_version(request):
    ...
    from testmanager.services import check_all_tests_completed
...
def testcase_test_it(request, id):
    ...
    from testmanager.version_service import get_versions_for_user, can_user_access_version, can_user_execute_version
